    ...
    <footer>
      ...
      <div className="bg-[#081627] text-white/60 py-12 px-4">
        ...
        <div className="container mx-auto grid md:grid-cols-4 gap-8">
          ...
          <div className="footer-section">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                ...
                <p>704 Lundy Way, Pacifica, CA, 94044</p>
              </li>
              <li className="pt-2">
          ...
          <div className="footer-section">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                ...
                <p>6th Floor, Pentagon P2, Magarpatta City, Pune - 411013</p>
              </li>
              <li className="pt-2">
                <a href="mailto:vaasudev@perfect108.com" className="footer-link">vaasudev@perfect108.com</a>
              </li>
              <li>
                <a href="tel:+919373097062" className="footer-link">+91 (93730) 97062</a>
              </li>
            </ul>
          </div>
          ...
          {/* Quick Links */}
          <div className="footer-section">
            <h4 className="font-semibold text-white text-xs mb-4">Quick Links</h4>
            <ul className="space-y-2">
              {["About Us", "Our Services", "Careers", "Contact Us", "Blog", "Success Stories"].map((link) => (
                <li key={link}>
